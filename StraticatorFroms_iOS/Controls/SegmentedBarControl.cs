...
namespace StraticatorFroms_iOS.Controls
{
    public class SegmentedBarControl : ContentView
    {
        ...
        public static readonly BindableProperty FontAttributeProperty = BindableProperty.Create(nameof(FontAttributes), typeof(FontAttributes), typeof(SegmentedBarControl), FontAttributes.Bold);
